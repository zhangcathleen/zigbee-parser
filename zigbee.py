          ...
          if 'zbee_nwk' in dir(pk):
            ...
            if zbee.frame_type == '0x00000001':
                      ...
                      if (zbee.src == ip[1]):
                        if (zbee.dst == ip[0]):
                          ...
                          if elapsed <= 60:
                            ...
                            delete.append(time)
                            # print(f'rejoin request {time} : [ {zbee.dst}, {zbee.src} ]')
                          elif elapsed > 60:
                            leave_3 = leave_3 + 1
              ...
              if zbee.radius != '1':
                ...
                # if frame.number == '1706':
                #     print(f'1706 : {zbee.data_len}')
                #     print(f'{zbee}')
                #     print(f'wpan src 64 ')
                #     print(wpan)
                if zbee.data_len == '4':
                  ...
                  #     continue
                  # except AttributeError:
                  #   print(f'{frame.number} : attribute error')
                ...
                if zbee.dst != '0x0000fffc':
                  ...
                  if zbee.data_len == '4':
                    try:
                      ...
                      print(f'attribute error route record : {frame.number}')
...
#    print(f'network_id : [mac]\n{network_mac}')
    ...
    print(f"\nnetwork status packets 2 + 3: {len(network_status_packets)}")
